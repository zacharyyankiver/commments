declare module '@contentful/f36-tokens' {
    ...
    /**
     * @description Geist Sans, -apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol
     */
    "fontStackPrimary": string,
    /**
     * @description Geist Mono, SFMono-Regular, Consolas, Liberation Mono, Menlo,monospace
     */
