import { Collection, MakeRequest, PaginationQueryParams, QueryOptions, QueryParams, GetAppDefinitionParams, CursorPaginatedCollection, GetEnvironmentTemplateParams, BasicCursorPaginationOptions } from './common-types';
...
export default function createClientApi(makeRequest: MakeRequest): {
     ...
     * ```
     */
    getEnvironmentTemplate: ({ organizationId, environmentTemplateId, version, query, }: import("./common-types").GetOrganizationParams & {
